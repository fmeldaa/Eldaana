...
def show_email_page(profile: dict):
    ...
    if not token:
        ...
        with col1:
            st.image("https://api.iconify.design/logos:google-gmail.svg", width=24)
        with col2:
        ...
        col1, col2 = st.columns([1, 8])
        with col1:
            st.image("https://api.iconify.design/logos:microsoft-outlook.svg", width=24)
        with col2:
        ...
        col1, col2 = st.columns([1, 8])
        with col1:
            st.image("https://api.iconify.design/material-symbols:mail.svg", width=24)
        with col2:
